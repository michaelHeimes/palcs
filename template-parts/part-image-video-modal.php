...
<?php if( !empty($video_url) ):?>
	<div class="reveal" id="<?=sanitize_title($modal_id);?>-video-modal" data-reveal data-animation-in="fade-in fast" data-animation-out="fade-out fast" data-reset-on-close="true">
