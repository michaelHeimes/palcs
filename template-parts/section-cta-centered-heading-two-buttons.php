<?php
$ctachwtb_background_image = get_field('ctachwtb_background_image') ?? get_sub_field('ctachwtb_background_image') ?? null;
$ctachwtb_heading = get_field('ctachwtb_heading') ?? get_sub_field('ctachwtb_heading') ?? null;
$ctachwtb_button_link_1 = get_field('ctachwtb_button_link_1') ?? get_sub_field('ctachwtb_button_link_1') ?? null;
$ctachwtb_button_link_2 = get_field('ctachwtb_button_link_2') ?? get_sub_field('ctachwtb_button_link_2') ?? null;
?>
