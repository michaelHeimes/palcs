				...
				<div id="options" class="tax-menu-wrap">
					<div class="stages tax-menu grid-x grid-padding-x font-size-20">
						...
						<div class="cell shrink top-level">
							<a class="button filter-btn no-style<?php if( !empty($stage) && $term->slug == $stage->slug) { echo ' active'; };?>" href="/about-us/teachers-staff/<?=esc_attr( $term->slug );?>/">
								<?=esc_html( $term->name );?>
							</a>
						</div>
						<?php endforeach; endif;?>
						<div class="cell shrink top-level">
							<a class="button filter-btn no-style all" href="/about-us/teachers-staff/">
								All
							</a>
						</div>
					</div>
