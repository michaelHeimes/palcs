		...
		<div class="inner-content">
			...
			<main id="primary" class="site-main">
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="alm-filtered teachers-staff init">
						<div class="grid-container">
							<div class="grid-x grid-padding-x align-center">
								<div class="cell small-12 xlarge-10">
						
									<div class="alm-filter-nav">
										<div class="stages grid-x grid-padding-x font-size-20">
										...
										<div class="other-terms grid-x grid-padding-x">
									...
									<?=do_shortcode( '[ajax_load_more id="alm_8413842141" post_type="teacher-staff" posts_per_page="12" scroll="false" css_classes="grid-x grid-padding-x"]' );?>
								</div>
							</div>
						</div>
					</div>
